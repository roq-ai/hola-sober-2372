...
function OrganizationListPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<OrganizationInterface[]>(
    ...
    () =>
      getOrganizations({
        relations: ['user', 'event.count', 'meeting.count', 'song.count'],
      }),
  );
            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  {hasAccess('meeting', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>meeting</Th>}
                  {hasAccess('song', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>song</Th>}
                  <Th>Actions</Th>
                </Tr>
              </Thead>
              <Tbody>
