...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['administrator', 'community-manager', 'support-staff'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Meeting', path: '/meetings', entity: 'meeting', service: AccessServiceEnum.PROJECT, icon: FiClock },
    {
      name: 'Sober Counter',
      path: '/sober-counters',
    ...
    { name: 'Song', path: '/songs', entity: 'song', service: AccessServiceEnum.PROJECT, icon: FiMusic },
